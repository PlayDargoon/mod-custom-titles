...
- Игрок получает персональное поздравление
- **Серверный анонс всем игрокам** о получении звания
- Звание становится активным автоматически

**Сообщения:**
- Игроку: "Поздравляем, [Имя]! Вы заслужили звание: [Название]"
- Всем на сервере: "[Серверное объявление] [Имя] заслужил(а) звание: [Название]"

---

### 2. Снять звание с игрока
```
...
```
1. GM проверяет список в README.md или документации

2. GM выдает звание победителю:
   .ctitle add ИмяПобедителя 180

3. Игрок видит сообщение:
   "Поздравляем, ИмяПобедителя! Вы заслужили звание: Легендарный Воин"

4. Весь сервер видит анонс:
   "[Серверное объявление] ИмяПобедителя заслужил(а) звание: Легендарный Воин"
```
